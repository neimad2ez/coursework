 ...
 */
public class SportsHall extends Facility implements Building{
  int level = 1;
  int baseBuildingCost = 500;
  int maxLevel = 3;
  int baseCapacity = 15;
   ...
   */
  public int getUpgradeCost() { //Returns the amount of ECS coins needed to get to the next level of SportsHall
    if(level == maxLevel) {
